...
const (
	Users_GetUser_FullMethodName   = "/trailbox.users.Users/GetUser"
	Users_ListUsers_FullMethodName = "/trailbox.users.Users/ListUsers"
)
...
type UsersClient interface {
	GetUser(ctx context.Context, in *common.UserId, opts ...grpc.CallOption) (*User, error)
...
func (c *usersClient) GetUser(ctx context.Context, in *common.UserId, opts ...grpc.CallOption) (*User, error) {
...
type UsersServer interface {
	GetUser(context.Context, *common.UserId) (*User, error)
...
func (UnimplementedUsersServer) GetUser(context.Context, *common.UserId) (*User, error) {
...
func _Users_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).GetUser(ctx, req.(*common.UserId))
	}
...
var Users_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "trailbox.users.Users",
